        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "‹ لتنصيب بوت ›", url=f"https://t.me/s_l_3"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/a391361f6f0ecba8a921e.jpg",
        caption=f"""Programmer [‹ 𝖳𝖾𝖠𝗆 Mekabo › .](https://t.me/PPPPRN) 𖡼\nᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ 𖡼\nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𖡼""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("‹ 𝖳𝖾𝖠𝗆 Mekabo › .", url=f"https://t.me/PPPPRN"),
            ],
            [
                InlineKeyboardButton(
                    "- محمد علي .", url=f"https://t.me/s_l_3"
                ),
            ],
            [
